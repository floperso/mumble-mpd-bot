...
const ProtobufCEnumValue mumble_proto__reject__reject_type__enum_values_by_number[9] =
{
...
const ProtobufCEnumValueIndex mumble_proto__reject__reject_type__enum_values_by_name[9] =
{
  { "AuthenticatorFail", 8 },
  { "InvalidUsername", 2 },
  { "NoCertificate", 7 },
...
static const ProtobufCFieldDescriptor mumble_proto__user_list__user__field_descriptors[4] =
{
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(MumbleProto__UserList__User, last_seen),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_UINT32,
    PROTOBUF_C_OFFSETOF(MumbleProto__UserList__User, has_last_channel),
    PROTOBUF_C_OFFSETOF(MumbleProto__UserList__User, last_channel),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
